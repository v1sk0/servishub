...
def register_routes():
    ...
    """
    from . import auth, tickets, inventory, tenant, locations, users, marketplace, orders, messages, services, public, threads, connections, credits, service_requests, pos, goods, finance, part_offers
